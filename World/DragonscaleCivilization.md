...
* 「竜鱗の文明」のシンボリズムは「翼ある蛇」。「ターコイズの勇ましさ」と「エメラルドの賢さ」の象徴です。
* 「竜麟の文明」は密林と高山をその領域とする異世界の文明です。
